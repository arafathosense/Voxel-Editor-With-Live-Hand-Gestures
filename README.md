...
Built by **arafathosense**, this project recreates the viral "schach" demo: a turquoise voxel art tool that floats over your webcam feed and reacts to real hand gestures. Two targets are included:
...
1. Click **Fork** on GitHub under `arafathosense`.
...
Feel free to tag @arafathosense when you post your recreation—would love to see the hand sculptures you make.
